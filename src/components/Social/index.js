        ...
        <>
            <section className="page-section" id="services">
                <div className="container">
                    <h2 className="text-center mt-0">Social Media</h2>
                    <hr className="divider my-4" />
                    <div className="row">
                        <div className="col-lg-3 col-md-6 text-center">
                            <div className="mt-5">
                                <i className="fab fa-4x fa-instagram text-primary mb-4"></i>
                                <h3 className="h4 mb-2"><a href="https://instagram.com/kenogonda/" target="_blank" rel="noreferrer">Instagram</a></h3>
                        ...
                        <div className="col-lg-3 col-md-6 text-center">
                            <div className="mt-5">
                                ...
                                <h3 className="h4 mb-2"><a href="https://linkedin.com/in/kennedyoginga" target="_blank" rel="noreferrer">LinkedIn</a></h3>
                        ...
                        <div className="col-lg-3 col-md-6 text-center">
                            <div className="mt-5">
                                ...
                                <h3 className="h4 mb-2"><a href="https://facebook.com/ken.mcoginga" target="_blank" rel="noreferrer">Facebook</a></h3>
                        ...
                        <div className="col-lg-3 col-md-6 text-center">
                            <div className="mt-5">
                                ...
                                <h3 className="h4 mb-2"><a href="https://github.com/KenOginga" target="_blank" rel="noreferrer">Github</a></h3>
